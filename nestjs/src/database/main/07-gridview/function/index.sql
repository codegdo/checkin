...
$BODY$
  ...
  BEGIN
    ...
    SELECT
      ...
      gc.data,
      gc.lookup,
      COALESCE(((gcf.data ->> gc.name)::jsonb ->> 'isPrimary')::boolean, gc.is_primary) is_primary,
...
DROP FUNCTION IF EXISTS org.fn_get_gridview;
DROP FUNCTION IF EXISTS org.fn_get_gridview_column;
*/