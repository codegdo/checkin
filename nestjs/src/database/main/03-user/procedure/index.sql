...
DROP PROCEDURE IF EXISTS sec.pr_user_get_all(varchar, integer, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar, int, int, varchar, varchar, json, json, json);
