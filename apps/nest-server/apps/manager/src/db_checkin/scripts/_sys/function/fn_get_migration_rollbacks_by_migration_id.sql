CREATE OR REPLACE FUNCTION _sys.fn_get_migration_rollbacks_by_migration_id(input_migration_id INT)
RETURNS TABLE (
  id INT,
...
-- SELECT * FROM _sys.fn_get_migration_rollbacks_by_migration_id(1);