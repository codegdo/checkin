/*
  Author: Giang Do
  Date: 09/18/2023
  Description: This stored procedure updates the _sys.migration table with migration
  execution details and inserts an audit record into the _sys.migration_audit table.
 ...
 */
CREATE OR REPLACE PROCEDURE _sys.pr_migration_update_complete(
  IN payload JSON,
...
BEGIN
  ...
  -- INSERT INTO _sys.migration_audit (migration_id, updated_at, updated_by)
