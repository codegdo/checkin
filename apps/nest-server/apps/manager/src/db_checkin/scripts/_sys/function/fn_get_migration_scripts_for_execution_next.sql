CREATE OR REPLACE FUNCTION _sys.fn_get_migration_scripts_for_execution_next(input_migration_id INT)
RETURNS TABLE (
  id INT,
...
-- SELECT * FROM _sys.fn_get_migration_scripts_for_execution_next(1);