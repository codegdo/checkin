-- Create the 'dbo.business_type' table
CREATE TABLE IF NOT EXISTS dbo.business_type (
  id SERIAL PRIMARY KEY,
  category VARCHAR(100) NOT NULL,
  description TEXT,
  industry_id INT REFERENCES dbo.industry(id),
...
INSERT INTO dbo.business_type (category, description, industry_id)
VALUES
...
INSERT INTO dbo.business_type (category, description)
VALUES
