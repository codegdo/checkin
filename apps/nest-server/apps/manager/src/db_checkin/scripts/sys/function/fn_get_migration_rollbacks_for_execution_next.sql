...
CREATE OR REPLACE FUNCTION sys.fn_get_migration_rollbacks_for_execution_next(input_migration_id INT)
RETURNS TABLE (
  id INT,
...
DECLARE
  last_migration_executed sys.migration;
  rollback_id INT;
BEGIN
...
-- SELECT * FROM sys.fn_get_migration_rollbacks_for_execution_next(1);
