CREATE OR REPLACE FUNCTION sys.fn_get_migration_scripts_for_execution_next(input_migration_id INT)
RETURNS TABLE (
  id INT,
...
-- SELECT * FROM sys.fn_get_migration_scripts_for_execution_next(1);