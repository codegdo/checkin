-- Create the '_dbo.business_type' table
CREATE TABLE IF NOT EXISTS _dbo.business_type (
  id SERIAL PRIMARY KEY,
  category VARCHAR(100) NOT NULL,
  description TEXT,
  industry_id INT REFERENCES _dbo.industry(id),
...
INSERT INTO _dbo.business_type (category, description, industry_id)
VALUES
...
INSERT INTO _dbo.business_type (category, description)
VALUES
