-- Create the 'org.form_field' table
...
BEFORE UPDATE ON org.form_field
FOR EACH ROW
EXECUTE FUNCTION fn_updated_at();

-- Insert data into the 'form_field' table
INSERT INTO org.form_field (form_id, field_id, title, translation, options, is_required) VALUES
