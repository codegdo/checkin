...
CREATE OR REPLACE FUNCTION main_sys.fn_get_migration_rollbacks_for_execution_next(input_migration_id INT)
RETURNS TABLE (
  id INT,
...
DECLARE
  last_migration_executed main_sys.migration;
  rollback_id INT;
BEGIN
...
-- SELECT * FROM main_sys.fn_get_migration_rollbacks_for_execution_next(1);
