export const configTablesAndFunctions = {
  scripts: [
    // TABLES
    {
      ...
      scriptType: 'sql',
      scriptOrder: '0',
      scriptPath: 'db_checkin/scripts/_sys/table/config.sql',
    },
    // FUNCTIONS
    {
      id: 100,
      ...
      scriptType: 'sql',
      scriptOrder: '100',
      scriptPath: 'db_checkin/scripts/_sys/function/fn_get_config_by_key.sql',
    },
    {
      id: 101,
      databaseName: 'db_checkin',
      ...
      scriptOrder: '101',
      scriptPath:
        'db_checkin/scripts/_sys/function/fn_is_config_key_boolean.sql',
    },
  ],
  rollbackScripts: [
    {
