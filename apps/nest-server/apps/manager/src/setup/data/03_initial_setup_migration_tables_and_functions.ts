export const migrationTablesAndFunctions = {
  migrationScripts: [
    // TABLES
    {
      ...
      scriptType: 'sql',
      scriptOrder: '1',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration_category.sql',
    },
    {
      id: 2,
      databaseName: 'db_checkin',
      ...
      scriptType: 'sql',
      scriptOrder: '2',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration.sql',
    },
    {
      id: 3,
      databaseName: 'db_checkin',
      ...
      scriptType: 'sql',
      scriptOrder: '3',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration_rollback.sql',
    },
    {
      id: 4,
      databaseName: 'db_checkin',
      ...
      scriptType: 'sql',
      scriptOrder: '4',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration_script.sql',
    },
    {
      id: 5,
      databaseName: 'db_checkin',
      ...
      scriptType: 'sql',
      scriptOrder: '5',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration_dependency.sql',
    },
    {
      id: 6,
      databaseName: 'db_checkin',
      ...
      scriptType: 'sql',
      scriptOrder: '6',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration_tag.sql',
    },
    {
      id: 7,
      databaseName: 'db_checkin',
      ...
      scriptType: 'sql',
      scriptOrder: '7',
      scriptPath: 'db_checkin/scripts/main_sys/table/migration_metadata.sql',
    },
    // FUNCTIONS
    {
      id: 100,
    ...
    },
    {
      ...
      scriptOrder: '101',
      scriptPath:
        'db_checkin/scripts/main_sys/function/fn_get_migration_by_category.sql',
    },
    {
      id: 102,
      databaseName: 'db_checkin',
    ...
    },
    {
      ...
      scriptOrder: '105',
      scriptPath:
        'db_checkin/scripts/main_sys/function/fn_get_migration_rollbacks_for_execution_next.sql',
    },
    {
      id: 106,
      databaseName: 'db_checkin',
      ...
      scriptOrder: '106',
      scriptPath:
        'db_checkin/scripts/main_sys/function/fn_get_migration_scripts_for_execution_next.sql',
    },
    // PROCEDURES
    {
      id: 200,
    ...
    },
    {
      ...
      scriptOrder: '202',
      scriptPath:
        'db_checkin/scripts/main_sys/procedure/pr_migration_update_complete.sql',
    },
  ],
  rollbackScripts: [
    {
