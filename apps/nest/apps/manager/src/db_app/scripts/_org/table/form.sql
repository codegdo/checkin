-- Create the '_org.form' table
CREATE TABLE IF NOT EXISTS _org.form (
...
BEFORE UPDATE ON _org.form
FOR EACH ROW
EXECUTE FUNCTION fn_updated_at();

-- Insert data into the 'form' table
INSERT INTO _org.form(form_type_id, company_id, title, description, is_active, is_published) VALUES
