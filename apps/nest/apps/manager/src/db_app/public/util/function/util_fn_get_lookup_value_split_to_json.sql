...
CREATE OR REPLACE FUNCTION util_fn_get_lookup_value_split_to_json(lookupValue TEXT)
RETURNS JSON
AS $$
DECLARE
  parts TEXT[];
...
REVOKE EXECUTE ON FUNCTION util_fn_get_lookup_value_split_to_json(text) FROM public;

--SELECT util_fn_get_lookup_value_split_to_json('db_checkin.public.business_type.category'); -- Returns JSON object