...
CREATE OR REPLACE FUNCTION util_fn_get_lookup_value(
  lookupValue TEXT,
...
REVOKE EXECUTE ON FUNCTION util_fn_get_lookup_value(text, integer) FROM public;

-- SELECT * FROM util_fn_get_lookup_value('checkin.main_com.form.title.id.company_id', 1);
