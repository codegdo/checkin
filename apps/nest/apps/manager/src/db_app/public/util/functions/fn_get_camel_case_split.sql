...
CREATE OR REPLACE FUNCTION fn_get_camel_case_split(inputString TEXT)
RETURNS TEXT AS $$
DECLARE
  result TEXT;
BEGIN
...
REVOKE EXECUTE ON FUNCTION fn_get_camel_case_split(text) FROM public;

--SELECT fn_get_camel_case_split('companyStreetAddress');