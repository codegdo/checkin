CREATE OR REPLACE FUNCTION fn_config_get_config_by_key(configName TEXT)
RETURNS TABLE (
  key_exists BOOLEAN,
...
REVOKE EXECUTE ON FUNCTION fn_config_get_config_by_key(text) FROM public;

-- SELECT * FROM fn_config_get_config_by_key('ENABLE_DROP_DB_SYSTEM_CONFIG');
