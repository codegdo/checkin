CREATE OR REPLACE FUNCTION migration_fn_get_previous_migration()
...
REVOKE EXECUTE ON FUNCTION migration_fn_get_previous_migration() FROM public;

-- SELECT * FROM migration_fn_get_previous_migration();
