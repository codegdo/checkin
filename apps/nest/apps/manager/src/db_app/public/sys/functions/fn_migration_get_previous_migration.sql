CREATE OR REPLACE FUNCTION fn_migration_get_previous_migration()
...
REVOKE EXECUTE ON FUNCTION fn_migration_get_previous_migration() FROM public;

-- SELECT * FROM fn_migration_get_previous_migration();
