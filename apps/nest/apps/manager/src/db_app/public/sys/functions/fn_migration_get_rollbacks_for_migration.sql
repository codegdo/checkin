CREATE OR REPLACE FUNCTION fn_migration_get_rollbacks_for_migration(migrationId INT)
RETURNS TABLE (
  id INT,
...
REVOKE EXECUTE ON FUNCTION fn_migration_get_rollbacks_for_migration(integer) FROM public;

-- SELECT * FROM fn_migration_get_rollbacks_for_migration(1);
