CREATE OR REPLACE FUNCTION fn_config_check_key_is_boolean(
  configName TEXT,
...
REVOKE EXECUTE ON FUNCTION fn_config_check_key_is_boolean(text, text, varchar, boolean) FROM public;

/*
DO $$
BEGIN
  IF fn_config_check_key_is_boolean('ENABLE_DROP_DB__sysTEM_CONFIG') THEN
